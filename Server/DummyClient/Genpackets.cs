...
class C2S_PlayerInfoReq : IPacket//PlayerInfoReq//:Packet
    {
...
class S2C_Test : IPacket//PlayerInfoReq//:Packet
    {
...
class C2S_Chat : IPacket//PlayerInfoReq//:Packet
    {
...
class S2C_Chat : IPacket//PlayerInfoReq//:Packet
    {
    ...
    public ushort Protocol { get { return (ushort)PacketID.S2C_Chat; } }
        ...
        public /*override*/ void Read(ArraySegment<byte> segment)
        {
	        ...
	        /*id*/this.playerId = BitConverter./*ToInt32*/ToInt32(s.Slice(count, s.Length - count));
	        count += sizeof(int/*int*/);
